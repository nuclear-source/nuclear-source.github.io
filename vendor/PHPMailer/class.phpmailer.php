...
class PHPMailer
{
    ...
    public function __construct($exceptions = false)
    {
        ...
        if (version_compare(PHP_VERSION, '5.1.2', '>=')) {
            ...
            if ($autoload === false or !in_array('PHPMailerAutoload', $autoload)) {
                require '../../../nc-content/content-core/third_party/PHPMailer/PHPMailerAutoload.php';
            }
        }
    }
    ...
    public function isSendmail()
    {
        if (!stristr(ini_get('sendmail_path'), 'sendmail')) {
            $this->Sendmail = '/xampp/sendmail/sendmail';
        }
    ...
    {
        if ($advanced) {
            require_once '../../../nc-content/content-core/third_party/PHPMailer/extras/class.html2text.php';
